...
int main(int argc, char* argv[]) {
    ...
    */    
    ...
    // compiled with 64bit (-m64)
    long vBytes = TbbVec1.size() * sizeof(long);
    ...
    cout << "reduced size:" << h_vec_3.size() << ":" << counter2 << endl;
    ...
    long new_size = new_end.first - k_out;
    cout << "MOD1:new_size:" << new_size << endl;
    ...
    cout << "MOD2:new_size2:" << new_size2 << endl;
    ...
    cout << "reduced size:" << h_vec_3.size() << endl;
